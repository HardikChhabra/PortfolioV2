  ...
  return (
    ...
    <div className="h-full w-full relative flex flex-col items-start gap-5 overflow-hidden">
      <div className="flex flex-col gap-5">
        <Heading>
          {portfolioConfig.title} And Web Developer,
          <br /> Based In {portfolioConfig.about.personalInfo.nationality}.
        </Heading>
      ...
      <FramerWrapper className="block" y={100} delay={0.31}>
        ...
        <div className="w-full h-fit p-2 flex flex-row justify-between gap-2 max-lg:flex-col">
          {items.map((val, indx) => {
            return (
              <div
                key={indx}
