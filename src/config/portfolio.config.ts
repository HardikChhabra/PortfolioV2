export const portfolioConfig = {
  ...
  // Contact Information
  email: "hardikchhabra3007@gmail.com", // Replace with actual email if available

  // Social Media Links
  //Fix no links error
  socialLinks: {
    /* facebook: "https://www.facebook.com/shahina.khatun.1044", */
    twitter: "https://twitter.com/HardikChhabra30",
    linkedin: "https://bit.ly/HardikChhabra-linkedin",
    /* external: "https://tinyurl.com/MdTaquiImam", */
    github: "https://github.com/hardikchhabra", // Assuming this is the GitHub link
  },
  ...
  seo: {
    ...
    authors: [
      {
        name: "Hardik Chhabra",
        url: "https://github.com/hardikchhabra",
      },
    ],
  },
  ...
  // About Information
  about: {
    bio: "A dedicated computer science student with a strong aptitude for problem-solving. My proficiency in algorithmic thinking and coding allows me to address challenges effectively and efficiently.",
    hobbies: [
      "Coding",
      "Playing Games",
      "Watching Anime",
  ...
  education: [
    {
      ...
      location: "Vivekananda Institute of Professional Studies",
      period: "July 2022 - 2026",
      description:
        "I am currently Studying Bachelor of Technology in Computer Science form Vivekanada Institute of Proffesional Studies, a college accredited under IPU. The program has provided me with a well-rounded education, covering both theoretical foundations and practical applications of computer science.",
    },
  ],
  ...
  experience: [
    {
      ...
      institution: "FoundIt (formerly Monster.com)",
      location: "Noida",
      period: "Jul 2024 - Oct 2024",
      description:
        "Enhanced frontend design through responsive techniques with Tailwind CSS and a modular component approach, allowing for efficient UI management and development and implemented profile page features (forms, modals) with React Hook Form and custom hooks, cutting data-fetch errors by 20% through API integration",
    },
  ],
